 ...
 * @author Lee
 */
public class BioCellStruc extends javax.swing.JFrame {

    /**
     * Creates new form BioCellStruc
     */
    public BioCellStruc() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        BioCellImg = new javax.swing.JLabel();
        CellStrucTitle = new javax.swing.JLabel();
        ...
        BioCellImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/biologygameapp/cell structure.png"))); // NOI18N
        BioCellImg.setText("jLabel1");
        getContentPane().add(BioCellImg);
        BioCellImg.setBounds(-40, 100, 340, 190);

        CellStrucTitle.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        CellStrucTitle.setForeground(new java.awt.Color(0, 204, 102));
        CellStrucTitle.setText("Cell Structure");
        getContentPane().add(CellStrucTitle);
        CellStrucTitle.setBounds(100, 0, 160, 60);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BioCellStruc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BioCellStruc().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel BioCellImg;
    private javax.swing.JLabel BioHistoryBackground;
    private javax.swing.JLabel CellStrucTitle;
